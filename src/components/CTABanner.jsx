...
const TRUST_ITEMS = ['Confidential', 'No Obligation', 'Strategic Insights']
    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h2 ref={h2Ref} className="text-4xl md:text-6xl font-display font-bold mb-6 leading-tight relative z-10 fade-in">
          ...
          <span className="text-gradient">Business Asset?</span>
        </h2>
        <p ref={pRef} className="text-xl text-cream/60 mb-12 max-w-2xl mx-auto relative z-10 fade-in stagger-1">
          Whether you're looking to optimize operations, prepare for sale, or explore acquisition
          opportunities, we should talk.
        </p>
